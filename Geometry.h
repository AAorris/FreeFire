...
inline double mag2(const scalar& s)
{
	return dot(s, s);
}

inline double dist(const scalar& s1, const scalar& s2 = scalar(0, 0))
{
...
// Generate a new permutation vector based on the value of seed
inline PerlinNoise::PerlinNoise(unsigned int seed) {
	p.resize(256);
...
inline double PerlinNoise::noise(double x, double y, double z) {
